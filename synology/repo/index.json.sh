#!/bin/sh
SPK_PACKAGE_FILE="synology/velux-nibe-${SPK_ARCH:-x86_64}-${SPK_PACKAGE_SUFFIX:-latest}.spk"
cat <<EOF
{
  "packages": [
    {
      ...
      "dname": "Velux-Nibe",
      "desc": "Velux-Nibe on Synology DSM.",
      "price": 0,
      ...
      "maintainer_url": "https://github.com/IngmarStein/velux-nibe",
      "distributor": "",
      "distributor_url": "",
      "support_url": "",
      "changelog": "",
